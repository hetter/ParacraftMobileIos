...
- under windows, it is "bootstrapper=\"script/shell_loop_getquestlist.teen.lua\"". 
...
local function activate()	
	...
	elseif(main_state==nil) then
		main_state=0;
		log("Hello World from script/shell_loop_getquestlist.teen.lua\n")
		
		NPL.load("(gl)script/apps/Aries/Quest/QuestHelp2.lua");
		local QuestHelp = commonlib.gettable("MyCompany.Aries.Quest.QuestHelp");
		QuestHelp.BuildChart("",true);
		commonlib.echo("Get quest_chart.teen.csv saved END !");
		ParaGlobal.Exit(0);
