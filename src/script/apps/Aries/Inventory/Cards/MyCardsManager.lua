...
local MyCardsManager = {
	filename = "config/aries/cardstemplate.xml",
	CardsViewPageCtrl = nil,
	--战斗背包
	combat_bags = {
	},
	MyCardsBagPageCtrl = nil,
	maxNum = 30,
	canEquipNum = 8,
	equipNum = 0,
};
commonlib.setfield("MyCompany.Aries.Inventory.Cards.MyCardsManager", MyCardsManager);
