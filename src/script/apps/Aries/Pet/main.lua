...
function CCS.GetCCSInfoString_for_GSL_agent()
	if(System.options.version == "kids") then
		local world = WorldManager:GetCurrentWorld();
		if(world and (world.name == "HaqiTown_RedMushroomArena_1v1" or world.name == "HaqiTown_RedMushroomArena_2v2" or string.match(world.name,"HaqiTown_RedMushroomArena_1v1"))) then
