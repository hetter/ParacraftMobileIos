...
function MicroOvenPanelPage.StartCooking()
	...
	elseif(gsids == "17001,17006,17048" and MicroOvenPanelPage.method == "boil") then
		...
		System.Item.ItemManager.DestroyItem(MicroOvenPanelPage.selected1_guid, 1, function(msg) 
			log("+++++++ Destroy raw food gsid:"..tostring(MicroOvenPanelPage.selected1_gsid).." guid:"..MicroOvenPanelPage.selected1_guid.." return: +++++++\n")
			commonlib.echo(msg);
		end);
		System.Item.ItemManager.DestroyItem(MicroOvenPanelPage.selected2_guid, 1, function(msg) 
			log("+++++++ Destroy raw food gsid:"..tostring(MicroOvenPanelPage.selected2_gsid).." guid:"..MicroOvenPanelPage.selected2_guid.." return: +++++++\n")
			commonlib.echo(msg);
		end);
		System.Item.ItemManager.DestroyItem(MicroOvenPanelPage.selected3_guid, 1, function(msg) 
			log("+++++++ Destroy raw food gsid:"..tostring(MicroOvenPanelPage.selected3_gsid).." guid:"..MicroOvenPanelPage.selected3_guid.." return: +++++++\n")
			commonlib.echo(msg);
		end);
		-- pick a random item
