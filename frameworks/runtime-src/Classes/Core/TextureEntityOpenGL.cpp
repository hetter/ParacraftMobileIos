			...
			if (texture)
			{
				...
				else
				{
					if (GetKey().find("blocks") != string::npos)
					{
                        ...
                        if (ccNextPOT(texture->getPixelsWide()) != texture->getPixelsWide() || ccNextPOT(texture->getPixelsHigh()) != texture->getPixelsHigh())
                        {
                            s_block_texture_params.wrapS = GL_CLAMP_TO_EDGE;
                            s_block_texture_params.wrapT = GL_CLAMP_TO_EDGE;
                        }
                        
                       // if (ccNextPOT(texture->getPixelsHigh()) != texture->getPixelsHigh())
                         //   s_block_texture_params.wrapT = GL_CLAMP_TO_EDGE;
